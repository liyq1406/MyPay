...
typedef enum {
    NLPrintResultSuccess,              //“00” 打印成功
    NLPrintResultDataError,            //”01“ 打印数据解析错误
    NLPrintResultGeneralError,         //“02” 通用错误
    NLPrintResultOutOfPaper,           //“04” 缺纸
    NLPrintResultHeatLimited,          //“08” 超温
    NLPrintResultFlashReadWriteError,  //“40” Flash 读写错误
    NLPrintResultBusy,                 //“80” 打印头忙
    NLPrintResultMacError,             //“41” MAC 校验错误
    NLPrintResultAlgorithmError,       //“42” 错误算法标识
    NLPrintResultKeyIndexError,        //“43” 错误密钥 ID
    NLPrintResultKeyLengthError,       //“45” 错误工作密钥长度
    NLPrintResultTimeOut,
    NLPrintResultCancel,
    NLPrintResultUnknown
}NLPrintResult;
